        ...
        <div className={`content ${DarkTheme && "dark"}`}>
            <div className="row header">
                ...
                <svg
                    ...
                    style={{ fill: '#6cc7c2', width: '256%', height: 200, }}
                >
                    <path
            ...
            <span className="section-title">Analytics Tools</span>
            ...
            <div className="row tall-square inv-bg">
                ...
                <div className="admin">
                    <div className="profile">
                        <img src=
                            "https://images.unsplash.com/photo-1479048266730-bbbfa1c246ac?q=80&w=1428&h=800&auto=format&fit=crop&crop=focalpoint&fp-x=0&ixlib=rb-4.0.3&ixid=M3"
                            alt="" className="profile-img" />
                    </div>

                    <div className="info">
                        <h2 className="admin-name">creative </h2>
                        <span className="admin-about">Full-stack & Photographer</span>
                    </div>
                ...
                <section>
                    ...
                    <div className="summary">
                        ...
                        <span className="summary-info">
                            ...
                            et iste? Similique molestiae iusto ut tenetur praesentium quasi, esse quis.
                        </span>
                    </div>
                    <CircularProgress
                        color="#0909ed"
            ...
            <div className="row side-rect">
                <section>
                    ...
                    <div className="more-details">
                        ...
                        <span className="txt">Lorem ipsum dolor sit amet consectetur,
                            adipisicing elit. Dolor temporibus impedit illo laudantium
                            dolore deleniti natus at obcaecati molestias fuga!</span>
                    </div>
                </section>
            </div>
            <div className="row side-rect">
